<template>
  <div
    ...
    :class="
      cn(
        'bg-white/10 dark:bg-black/10 backdrop-blur-md mx-auto mt-8 flex h-[38px] w-max rounded-2xl border border-[#ddddde] border-1px border-solid p-3 transition-all gap-4',
